...
//     return (
//         <div key={recommendation.id} className="bg-white rounded-md shadow-sm border border-gray-200">
//             <div className="p-6">
//                 {/* Header */}
//                 <div className="mb-4">
...
//                         <button className="w-full flex items-center justify-center py-2.5 px-4 border border-gray-300 rounded-md bg-white text-gray-700 font-medium hover:bg-gray-50 transition-colors duration-150">
